...
Th helm-deployer task step deploys a Helm chart to a Kubernetes cluster.
...
|| `ca` | mapping | The Tiller CA file contents | None | True |
|| `key` | mapping | The Tiller key file contents | None | True |
|| `cert` | mapping | The Tiller cert file contents | None | True |
